...
class SelectLocationViewController: UICollectionViewController {
    
    let cellId = "cellId"
    
    static let locationLabels = ["North", "South", "East", "West", "Central", ""]
    ...
    @objc func handleSelect() {
        print("Select")
        self.shareViewController?.selectedLocation = self.selectedLocation
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if selectedLocation != 5 {
            let selectedIndexPath = IndexPath(item: selectedLocation, section: 0)
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let prevSelection = selectedLocation
        
        if prevSelection == 5 {
            selectCell(indexPath: indexPath)
            selectedLocation = indexPath.item
        } else {
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return SelectLocationViewController.locationLabels.count - 1
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let label = UILabel()
        label.text = SelectLocationViewController.locationLabels[indexPath.item]
